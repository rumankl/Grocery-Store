...
//   return (
//     <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-60 mmd:overflow-y-scroll  mmd:h-screen mmd:w-screen" >
//       <div
//         className="relative m-4 p-4 w-2/5 min-w-[40%] max-w-[40%] rounded-lg bg-white shadow-md  mmd:text-white mmd:shadow-none mmd:w-full mmd:min-w-full mmd:max-w-full"
//         onClick={(e) => e.stopPropagation()} // Prevent click inside the dialog from closing it
//       >
//         <div className="text-slate-800 flex justify-end items-end z-0">

//           <i
//             className="text-white cursor-pointer flex justify-center items-center mt-[-10px] mr-[-15px] border-4 rounded-3xl border-orange-900 bg-orange-900 p-2 "
//             onClick={handleOpen}
//           >
//             X
//           </i>
